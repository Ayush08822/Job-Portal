...
import com.AyushToCode.JobPortalApplication.entity.*;
import com.AyushToCode.JobPortalApplication.services.*;
...
public class JobSeekerApplyController {
    ...
    public String display(@PathVariable("id") int id, Model model){
        ...
        List<JobSeekerApply> jobSeekerApplyList = jobSeekerApplyService.getJobs(jobDetails);
        List<JobSeekerSave> jobSeekerSaveList=jobSeekerSaveService.getJobs(jobDetails);
